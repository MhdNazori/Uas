...
import com.informatika19100008.MhdNazori_rangking_sekolah.service.SessionPreferences
...
class LoginActivity : AppCompatActivity() {
    ...
    fun actionData(username : String, password : String){
        koneksi.service.logIn(username, password).enqueue(object : Callback<responuser>{
